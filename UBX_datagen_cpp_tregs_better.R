...
dir_name_data = '/storage/homefs/bt25p365/tregs/mass_sim_results_R_cpp_tregs_better'
...
params_df = read.csv("/storage/homefs/bt25p365/tregs/tregs_better_parameters_ubelix.csv", stringsAsFactors = FALSE)
