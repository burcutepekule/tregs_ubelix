...
path      = "/Users/burcutepekule/Desktop/mass_sim_results_R_cpp_tregs_worse/"
...
if(file.exists('/Users/burcutepekule/Dropbox/tregs_ubelix/ids_read_jsd_tregs_worse.rds')){
  inds_read = readRDS('/Users/burcutepekule/Dropbox/tregs_ubelix/ids_read_jsd_tregs_worse.rds')
}else{
  inds_read = c()
}
...
if(length(inds2read)>0){
  ...
  for (i_idx in seq_along(inds2read)){
    ...
    if(length(inds2read) > 10 && i_idx %% 10 == 0){
      ...
      if(!file.exists('/Users/burcutepekule/Dropbox/tregs_ubelix/ids_read_jsd_tregs_worse.rds')){
        saveRDS(processed_indices, '/Users/burcutepekule/Dropbox/tregs_ubelix/ids_read_jsd_tregs_worse.rds')
      }else{
        inds_read_old = readRDS('/Users/burcutepekule/Dropbox/tregs_ubelix/ids_read_jsd_tregs_worse.rds')
        inds_read_updated = c(inds_read_old, processed_indices)
        saveRDS(inds_read_updated, '/Users/burcutepekule/Dropbox/tregs_ubelix/ids_read_jsd_tregs_worse.rds')
      }
      
      # Update the results data
      if(!file.exists('/Users/burcutepekule/Dropbox/tregs_ubelix/data_cpp_read_jsd_tregs_worse.rds')){
        saveRDS(all_comparison_results, '/Users/burcutepekule/Dropbox/tregs_ubelix/data_cpp_read_jsd_tregs_worse.rds')
      }else{
        all_comparison_results_old = readRDS('/Users/burcutepekule/Dropbox/tregs_ubelix/data_cpp_read_jsd_tregs_worse.rds')
        all_comparison_results_combined = rbind(all_comparison_results_old, all_comparison_results)
        saveRDS(all_comparison_results_combined, '/Users/burcutepekule/Dropbox/tregs_ubelix/data_cpp_read_jsd_tregs_worse.rds')
      }
  ...
  if(!file.exists('/Users/burcutepekule/Dropbox/tregs_ubelix/ids_read_jsd_tregs_worse.rds')){
    ...
    saveRDS(inds_read_final, '/Users/burcutepekule/Dropbox/tregs_ubelix/ids_read_jsd_tregs_worse.rds')
  }
  ...
  if(!file.exists('/Users/burcutepekule/Dropbox/tregs_ubelix/data_cpp_read_jsd_tregs_worse.rds')){
    ...
    saveRDS(all_comparison_results_final, '/Users/burcutepekule/Dropbox/tregs_ubelix/data_cpp_read_jsd_tregs_worse.rds')
  }
  ...
  tol_in      = 125*0.2
  M1_M2_diff  = 1
  source('~/Dropbox/tregs_ubelix/UBX_datazanalyse_jsd_regions_tregs_worse.R')
