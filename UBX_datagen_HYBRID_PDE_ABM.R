...
source("/storage/homefs/bt25p365/tregs/MISC/FAST_FUNCTIONS_CPP_ONELEVEL.R")
...
dir_name_data = '/storage/homefs/bt25p365/tregs/mass_sim_results_HYBRID_PDE_ABM'
...
memory_half_life = 20  # timesteps for engulfment memory decay
D_microbe = 0.15       # diffusion rate for pathogens/commensals
