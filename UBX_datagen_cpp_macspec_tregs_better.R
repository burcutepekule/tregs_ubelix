...
params_df = read.csv("./lhs_parameters_macspec_expanded_tregs_better.csv", stringsAsFactors = FALSE)
...
dir_name_data = '/Users/burcutepekule/Desktop/mass_sim_results_R_cpp_macspec_tregs_better'
