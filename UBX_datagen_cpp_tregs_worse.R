...
dir_name_data = '/storage/homefs/bt25p365/tregs/mass_sim_results_R_cpp_tregs_worse'
...
params_df = read.csv("/storage/homefs/bt25p365/tregs/tregs_worse_parameters_ubelix.csv", stringsAsFactors = FALSE)
