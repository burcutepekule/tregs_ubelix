...
if(file.exists('/Users/burcutepekule/Dropbox/tregs_ubelix/ids_read_cohens.rds')){
  inds_read = readRDS('/Users/burcutepekule/Dropbox/tregs_ubelix/ids_read_cohens.rds')
}else{
  inds_read = c()
}
...
if(length(inds2read)>0){
  ...
  for (i_idx in seq_along(inds2read)){
    ...
    if(length(inds2read) > 10 && i_idx %% 10 == 0){
      ...
      if(!file.exists('/Users/burcutepekule/Dropbox/tregs_ubelix/ids_read_cohens.rds')){
        saveRDS(processed_indices, '/Users/burcutepekule/Dropbox/tregs_ubelix/ids_read_cohens.rds')
      }else{
        inds_read_old = readRDS('/Users/burcutepekule/Dropbox/tregs_ubelix/ids_read_cohens.rds')
        inds_read_updated = c(inds_read_old, processed_indices)
        saveRDS(inds_read_updated, '/Users/burcutepekule/Dropbox/tregs_ubelix/ids_read_cohens.rds')
      }
      
      # Update the results data
      if(!file.exists('/Users/burcutepekule/Dropbox/tregs_ubelix/data_cpp_read_cohens.rds')){
        saveRDS(all_comparison_results, '/Users/burcutepekule/Dropbox/tregs_ubelix/data_cpp_read_cohens.rds')
      }else{
        all_comparison_results_old = readRDS('/Users/burcutepekule/Dropbox/tregs_ubelix/data_cpp_read_cohens.rds')
        all_comparison_results_combined = rbind(all_comparison_results_old, all_comparison_results)
        saveRDS(all_comparison_results_combined, '/Users/burcutepekule/Dropbox/tregs_ubelix/data_cpp_read_cohens.rds')
      }
  ...
  if(!file.exists('/Users/burcutepekule/Dropbox/tregs_ubelix/ids_read_cohens.rds')){
    ...
    saveRDS(inds_read_final, '/Users/burcutepekule/Dropbox/tregs_ubelix/ids_read_cohens.rds')
  }
  ...
  if(!file.exists('/Users/burcutepekule/Dropbox/tregs_ubelix/data_cpp_read_cohens.rds')){
    ...
    saveRDS(all_comparison_results_final, '/Users/burcutepekule/Dropbox/tregs_ubelix/data_cpp_read_cohens.rds')
  }
