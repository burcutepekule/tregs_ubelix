...
ggsave(
  filename = paste0("./treg_regions_PLS_DA_",inj_type,"_w_arrows_tregs_better.png"),
  plot = p2,
  width = 9,
  height = 6,
  dpi = 300,
...
ggsave(
  filename = paste0("./treg_regions_PLS_DA_",inj_type,"_w_arrows_tregs_better_new_points.png"),
  plot = p2,
  width = 9,
  height = 6,
  dpi = 300,
