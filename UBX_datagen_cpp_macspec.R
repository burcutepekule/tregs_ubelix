...
# ============================================================================
# C++ ACCELERATED DATA GENERATION SCRIPT - WITH MACROPHAGE SPECIFICITY
# ============================================================================
# This script uses C++ implementations for 20-100x speedup
# NEW: Includes macrophage discrimination efficiency and threshold parameters
# To use: Rscript UBX_datagen_cpp_macspec.R <n1> <n2>
# ============================================================================

cat("\n")
cat("=" = rep("=", 70), sep = "")
cat("\n🚀 C++ ACCELERATED TREGS SIMULATION - MACROPHAGE SPECIFICITY\n")
cat("=" = rep("=", 70), sep = "")
cat("\n\n")
...
cat("=" = rep("=", 70), sep = "")
cat("\n")
cat("Starting simulations with C++ acceleration and macrophage specificity...\n")
cat("=" = rep("=", 70), sep = "")
cat("\n\n")
